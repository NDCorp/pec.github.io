...
function enigma_child_enqueue_styles() 
{
	...
	//default theme css
	wp_enqueue_style('child-default-style', get_stylesheet_directory_uri() . '/css/default.css');
	//wp_enqueue_style('par-default-style', get_template_directory_uri() . '/css/default.css');
