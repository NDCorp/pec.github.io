...
<div class="container main_container">
	<div class="row enigma_blog_wrapper">
		<div class="col-md-8">
			...
			-->
			<?php global $postID; $postID = 2; query_posts('cat=' . $postID); //global $more; $more = 0; ?>
			<?php if (have_posts()): ?>
				<?php global $nbrPosts; $nbrPosts = 0; global $count_posts; $count_posts = get_category($postID); ?>
					...
					<div class="echild_event_container" id="<?php echo 'epost_' . $nbrPosts ?>">
						<div class="echild_event" style="background-color:<?php echo the_field('up_event_color'); ?>;">
							...
							<div class="echild_event_space echild_event_title">
								<h3><a href="<?php the_field('read_more_link'); ?>"><?php the_title(); ?></a></h3>
							</div>
							...
							<?php else: //load default background-image ?>
								<div class="enigma_blog_thumb_wrapper_showcase echild_event_space echild_event_info echild_event_imgdefault">
